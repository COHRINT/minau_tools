...
class AnalyzeData:
    def __init__(self,data,x,y,numassets):
        ...
        #Sets up place to store bagged data
        ...
        for i in range(len(self.bag_files)):
            ...
            self.truth_red[i] = self.extract_odometry('/red_actor_5/pose_gt',bag)
            self.truth_poses3[i] = self.extract_odometry('/dory/pose_gt',bag)
            self.truth_poses4[i] = self.extract_odometry('/guppy/pose_gt',bag)
            ...
            self.estimate3_poses3[i] = self.extract_odometry_network('/dory/etddf/estimate/network',bag,'dory')
            self.estimate4_poses4[i] = self.extract_odometry_network('/guppy/etddf/estimate/network',bag,'guppy')
            self.estimate3_poses4[i] = self.extract_odometry_network('/dory/etddf/estimate/network',bag,'guppy')
